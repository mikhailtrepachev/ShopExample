...
namespace ShopExample.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231226210512_AutoModel")]
    partial class AutoModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.Auto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.PersonalAuto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.Card", b =>
                {
                    b.HasOne("CleanArchitecture.Domain.Entities.PersonalAuto", "PersonalAuto")
                        .WithMany()
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Entities.PersonalAuto", b =>
                {
                    b.HasOne("CleanArchitecture.Domain.Entities.Auto", "Auto")
                        .WithMany()
